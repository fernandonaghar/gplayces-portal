(function() {
    ...
    PlacesEditAddressController.$inject = ['$scope', '$state', '$rootScope', 'PlaceService', 'GeneralServices', 'FlashService', '$stateParams', '$timeout'];

    function PlacesEditAddressController($scope, $state, $rootScope, PlaceService, GeneralServices, FlashService, $stateParams, $timeout) {
        var editaddr = this;
            ...
            PlaceService.SavePlace(editaddr.place).then(function(response) {
                if (response != null) {
                    if (response.success) {
                        ...
                        if (editaddr.place.isOwner || editaddr.isAdmin) {
                            $state.go('app.places.edit.contact', { place: editaddr.place });
                        } else {
