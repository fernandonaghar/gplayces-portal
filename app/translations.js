...
function config($translateProvider) {
    ...
    var en_translations = {
        ...
        'PLACE_ISACCESSIBLE_DETAIL': 'Accessible - Indicates that this establishment is available to be queried on Gplayces apps and visible to other users.',
        'PLACE_ACTIVE_DETAIL': 'Active - Indicates that this establishment is a valid record.',        
        'SEQUENCE': 'Sequence',
        'ADVANCE': 'Advance',
        ...
        'NEW_COVER_IMAGE': 'Choose new cover image',
    ...
    var pt_translations = {
        ...
        'ACTIVATE': 'Ativar',
        'ACTIVATION': 'Ativação',
        'PLACE_ISACCESSIBLE_DETAIL': 'Acessível - Indica que este estabelecimento está disponível para consulta nos aplications Gplayces por outros usuários.',
        'PLACE_ACTIVE_DETAIL': 'Ativo - Indica que este estabelecimento é um cadastro válido.',
        'SEQUENCE': 'Sequência',
        'ADVANCE': 'Avançar',
        ...
        'CHOOSE_A_PHOTO': 'Escolha uma foto',
        'CURRENT_COVER_IMAGE': 'Imagem de capa atual',
        'NEW_COVER_IMAGE': 'Escolher nova imagem de capa',
